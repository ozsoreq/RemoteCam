...
val PoseTypography = Typography(
    displayLarge = PoseType.Hero,
    headlineLarge = PoseType.Title,
    headlineSmall = PoseType.TitleSmall,
    bodyLarge = PoseType.Body,
    bodyMedium = PoseType.Body,
    labelLarge = PoseType.Label,
    labelMedium = PoseType.Caption,
    labelSmall = PoseType.Overline,
)
